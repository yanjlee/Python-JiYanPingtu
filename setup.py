...
setuptools.setup(
    name="Python-JiYanPingtu",
    version="1.12.15",
    author="yanjlee",
    author_email="yanjlee@163.com",
    description="jiyan拼图验证码，采用mitmdump脚本获取中间图片，用两张乱码图片合成一张新的图片，在用selenium+chrome滑动滑块",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/Python-JiYanPingtu",  # 模块github地址
